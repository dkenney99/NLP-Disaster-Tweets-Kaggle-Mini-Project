...
This project is part of the Kaggle competition Natural Language Processing with Disaster Tweets
.
...
Deliverable 1: Jupyter Notebook containing the full analysis (EDA, model training, evaluation, and discussion).

Deliverable 2: This GitHub repository with all project files and code.

Deliverable 3: Screenshot of the leaderboard position for the submitted model.
...
Build a BiLSTM neural network with embeddings.

Compare validation F1 scores and interpret results.
...
Embedding Layer — Converts token indices into dense 128-dimensional vectors.

Bidirectional LSTM — Reads text forward and backward to capture context.

Dense + Dropout Layers — For nonlinear transformations and regularization.

Sigmoid Output — Produces a probability for the disaster class.
...
TensorFlow / Keras Documentation
 — Embedding, LSTM, and Bidirectional Layers.
